import { createEditor, createDocument, createElement, paragraph, DEFAULT_PDF_LIMITS, exportPptx } from '@local/slidekit';
import type { Deck, EditorHandle, EditorOptions, Gradient, PdfImportOptions, PptxImportResult } from '@local/slidekit';
...
const options: EditorOptions = { document: doc, pdfLimits: DEFAULT_PDF_LIMITS, mode: 'edit' };
